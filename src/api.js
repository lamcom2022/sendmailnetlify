...
/*ejs.renderFile(
    // path.basename(__dirname, "./", "index1.ejs"),
    "src/mindbeyondpolicy.html",
    {
        data: req.body
    },
    (err, data) => {
        if (err) {
            ...
            pdf.create(data, option).toFile(`./testfile.pdf`, function (err, resp) {

                if (err) return console.log("pdferr", err);
                ...
                const mail = {
                    ...
                    attachments: [
                        {
                            filname: `${req.body.first_name}.pdf`,
                            path: data.filname
                        }]
                }
